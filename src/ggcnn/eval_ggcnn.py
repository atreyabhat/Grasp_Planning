...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for idx, (x, y, didx, rot, zoom) in enumerate(test_data):
            ...
            plt.imshow(q_img)
            plt.savefig(f'/home/venk/VBM_project/ggcnn/q_image_{idx}.png')
            plt.imshow(ang_img)
            plt.savefig(f'/home/venk/VBM_project/ggcnn/ang_image_{idx}.png')
            plt.imshow(width_img)
            plt.savefig(f'/home/venk/VBM_project/ggcnn/width_image_{idx}.png')
